      ...
      <nav className="flex w-full items-center justify-between gap-3 rounded-3xl border border-slate-200/80 bg-white/75 p-2.5 shadow-sm backdrop-blur sm:p-3">
        <div className="flex items-center gap-6">
          ...
          <div className="hidden md:flex items-center gap-5 border-l border-slate-200 pl-6">
            <Link to="/katalog-ryb" className="text-sm font-semibold text-slate-600 transition-colors hover:text-indigo-600">
              Katalog Ryb
            </Link>
            <Link to="/katalog-przynet" className="text-sm font-semibold text-slate-600 transition-colors hover:text-indigo-600">
              Katalog Przynęt
            </Link>
          </div>
        </div>
